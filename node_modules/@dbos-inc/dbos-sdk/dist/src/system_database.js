...
async function ensureSystemDatabase(sysDbUrl, logger, customPool, schemaName = 'dbos') {
    let client = null;
    if (customPool) {
...
class PostgresSystemDatabase {
    ...
    constructor(systemDatabaseUrl, logger, serializer, sysDbPoolSize = exports.DEFAULT_POOL_SIZE, systemDatabasePool, schemaName = 'dbos') {
    ...
    async init() {
        await ensureSystemDatabase(this.systemDatabaseUrl, this.logger, this.customPool ? this.pool : undefined, this.schemaName);
