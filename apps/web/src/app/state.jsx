  ...
  creators: [
    {
      ...
      type: 'influencer',
      name: 'Nia Rivers',
      handles: { instagram: '@niarivers', tiktok: '@niarivers' },
      followers: { instagram: 120000, tiktok: 98000 },
      engagement: 4.6,
      niche: 'Beauty',
      platforms: ['Instagram', 'TikTok'],
      gender: 'Female',
      region: 'US',
      notes: 'Top performer with skincare brands.',
    },
    {
      id: 'cr-002',
      type: 'influencer',
      name: 'Sara ElDin',
      handles: { instagram: '@saradaily', tiktok: '@saradaily' },
      followers: { instagram: 54000, tiktok: 62000 },
      engagement: 5.1,
      niche: 'Fashion',
      platforms: ['Instagram', 'TikTok'],
      gender: 'Female',
      region: 'Egypt',
      notes: 'Strong event coverage and brand partnership history.',
    },
    {
      id: 'cr-003',
      type: 'influencer',
      name: 'Ari Luna',
      handles: { instagram: '@ari.luna', tiktok: '@ariluna' },
      followers: { instagram: 89000, tiktok: 140000 },
      engagement: 6.3,
      niche: 'Wellness',
      platforms: ['Instagram', 'TikTok', 'YouTube'],
      gender: 'Female',
      region: 'UAE',
      notes: 'High engagement and upbeat tone.',
    },
    {
      id: 'cr-004',
      type: 'ugc',
      ...
      notes: 'Great for behind-the-scenes content.',
    },
    {
      id: 'cr-005',
      type: 'ugc',
      ...
      niche: 'Tech',
      region: 'US',
      portfolio: 'https://portfolio.example.com/alex',
      notes: 'Specializes in product unboxings and tech reviews.',
    },
    {
      id: 'cr-006',
      type: 'ugc',
      ...
      niche: 'Beauty',
      region: 'UAE',
      portfolio: 'https://portfolio.example.com/fatima',
      notes: 'Authentic testimonial style, great for skincare.',
    },
    {
      id: 'cr-007',
      type: 'influencer',
      name: 'Jordan Blake',
      handles: { instagram: '@jordanblake', tiktok: '@jblake', youtube: '@JordanBlakeVlogs' },
      followers: { instagram: 250000, tiktok: 180000, youtube: 95000 },
      engagement: 3.8,
      niche: 'Fitness',
      platforms: ['Instagram', 'TikTok', 'YouTube'],
      gender: 'Male',
      region: 'US',
      notes: 'Strong male audience, fitness and lifestyle content.',
    },
  ],
  campaignCreators: {
    'camp-001': {
